...
app.loader
  .add("chiple", "@/assets/chiple.png")
  .add("kerberos", "@/assets/kerberos.png")
  .add("load", "@/assets/load.png")
  .add("snaker", "@/assets/snaker.png")
  .load(onAssetsLoaded);
...
function onAssetsLoaded() {
  ...
  var slotTextures = [
    PIXI.Texture.from("@/assets/chiple.png"),
    PIXI.Texture.from("@/assets/kerberos.png"),
    PIXI.Texture.from("@/assets/load.png"),
    PIXI.Texture.from("@/assets/snaker.png")
  ];
